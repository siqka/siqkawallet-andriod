...
class AppConfigProvider : IAppConfigProvider, ILanguageConfigProvider, IBuildConfigProvider {
    ...
    override val companyWebPageLink: String = "https://soundtechfilm.com"
    override val appWebPageLink: String = "https://siqka.com"
    override val appGithubLink: String = "https://github.com/siqka/siqkawallet-andriod"
    override val companyTwitterLink: String = "https://twitter.com/siqkawallet"
    override val companyTelegramLink: String = "https://t.me/siqkawallet"
    override val companyRedditLink: String = "https://reddit.com/r/SIQKAWallet/"
    override val reportEmail = "siqkabox@gmail.com"
    override val walletHelpTelegramGroup = "SiqkaWallet"
    ...
    override val currencies: List<Currency> = listOf(
            Currency(code = "PKR", symbol = "Rs", decimal = 2),
